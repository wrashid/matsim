 ...
 * <li> It is now possible to inject this.  See {@link org.matsim.core.mobsim.qsim.QSimModule} for how the default is set up.   It can also be overridden in the usual way.
