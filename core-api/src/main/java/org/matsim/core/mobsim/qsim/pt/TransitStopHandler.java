...
public interface TransitStopHandler {
	 ...
	 * {@link PassengerAccessEgress#handlePassengerEntering(PTPassengerAgent, MobsimVehicle, Id, double)} and
	 * {@link PassengerAccessEgress#handlePassengerLeaving(PTPassengerAgent, MobsimVehicle, Id, double)} to let
