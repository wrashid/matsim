...
//		if (scenario.getPopulation() instanceof Population && ((Population)scenario.getPopulation()).isStreaming()) {
	...
	public void startTag(String name, Attributes atts, Stack<String> context) {
		...
		if (PopulationReaderMatsimV4.PLANS.equals(name)) {
			...
			if (PopulationReaderMatsimV4.PERSON.equals(name)) {
	...
	public void endTag(String name, String content, Stack<String> context) {
		...
		if (PopulationReaderMatsimV4.PLANS.equals(name)) {
			...
			if (PopulationReaderMatsimV4.PERSON.equals(name)) queue.add(currentPersonXmlData);
		}
	}
