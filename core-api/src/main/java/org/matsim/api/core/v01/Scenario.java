 ...
 * <p>
 * Scenario (and in particular {@link org.matsim.core.scenario.MutableScenario}) now accepts arbitrary implementations of the contributing containers.  As stated
...
public interface Scenario {
	 ...
	 * at this point injection is only possible after {@link org.matsim.core.controler.Controler} was started, which stands in the way of <i>first</i> constructing
	 * the scenario and only <i>then</i> starting {@link org.matsim.core.controler.Controler}.  So maybe we should un-deprecate this method.  Kai/Theresa, sep'16
