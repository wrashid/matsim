...
public class ExpBetaPlanSelectorTest extends AbstractPlanSelectorTest {
	...
	public void testGetSelectionProbability() {
		...
		PersonImpl person = new PersonImpl(Id.create(1, Person.class));
		PlanImpl plan1 = person.createAndAddPlan(false); 
		plan1.setScoreInfo(new ScoreInfoImpl(180.0));
		PlanImpl plan2 = person.createAndAddPlan(false); 
		plan2.setScoreInfo(new ScoreInfoImpl(180.1));
		PlanImpl plan3 = person.createAndAddPlan(false); 
		plan3.setScoreInfo(new ScoreInfoImpl(180.5));
		PlanImpl plan4 = person.createAndAddPlan(false); 
		plan4.setScoreInfo(new ScoreInfoImpl(169.9));
