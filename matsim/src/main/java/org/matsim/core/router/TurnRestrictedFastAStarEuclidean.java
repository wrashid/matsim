/* *********************************************************************** *
 * project: org.matsim.*
 * TurnRestrictedFastAStarEuclidean.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
 ...
 * @author cdobler
 */
public class TurnRestrictedFastAStarEuclidean extends FastAStarEuclidean implements TurnRestrictedLeastCostPathCalculator {

	private final static Logger log = Logger.getLogger(TurnRestrictedFastAStarEuclidean.class);
	...
	public TurnRestrictedFastAStarEuclidean(final LinkToLinkRoutingNetwork routingNetwork, final TravelDisutility costFunction, final TravelTime timeFunction,
			final PreProcessEuclidean preProcessData, final double overdoFactor, final FastRouterDelegateFactory fastRouterFactory) {
