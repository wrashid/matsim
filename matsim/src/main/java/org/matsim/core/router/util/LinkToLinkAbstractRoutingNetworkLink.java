...
public abstract class LinkToLinkAbstractRoutingNetworkLink implements LinkToLinkRoutingNetworkLink {

	private final Link link;
	private final RoutingNetworkNode toNode;
	private final RoutingNetworkNode fromNode;
	private RoutingNetworkNode[] fromNodes = null;
	
	/*package*/ LinkToLinkAbstractRoutingNetworkLink(Link link, RoutingNetworkNode fromNode, RoutingNetworkNode toNode) {
		this.link = link;
