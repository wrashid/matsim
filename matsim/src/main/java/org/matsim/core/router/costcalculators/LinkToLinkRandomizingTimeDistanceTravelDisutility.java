 ...
 * @author mrieser
 */
final class LinkToLinkRandomizingTimeDistanceTravelDisutility implements LinkToLinkTravelDisutility {

	private final LinkToLinkTravelTime timeCalculator;
	...
	LinkToLinkRandomizingTimeDistanceTravelDisutility(
			final LinkToLinkTravelTime timeCalculator,
	...
	@Override
	public double getLinkToLinkTravelDisutility(final Link prevLink, final Link link, final double time, final Person person, final Vehicle vehicle) {
		...
		double travelTime = this.timeCalculator.getLinkToLinkTravelTime(prevLink, link, time);
