/* *********************************************************************** *
 * project: org.matsim.*
 * LinkToLinkFastAStarEuclideanFactory.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
...
@Singleton
public class LinkToLinkFastAStarEuclideanFactory implements LinkToLinkLeastCostPathCalculatorFactory {
	...
	@Inject
	public LinkToLinkFastAStarEuclideanFactory() {
	...
	public synchronized LinkToLinkLeastCostPathCalculator createPathCalculator(final Network network, final Lanes lanes, final LinkToLinkTravelDisutility travelCost, final LinkToLinkTravelTime travelTime) {
		...
		if (routingNetwork == null) {
			...
			if (preProcessEuclidean == null) {
				preProcessEuclidean = new PreProcessEuclidean(new TravelDisutility() {
					@Override
		...
		return new LinkToLinkFastAStarEuclidean(routingNetwork, travelCost, travelTime, preProcessEuclidean, overdoFactor);
	}
}