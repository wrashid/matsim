/* *********************************************************************** *
 * project: org.matsim.*
 * TurnRestrictedFastAStarLandmarksFactory.java
 *                                                                         *
 * *********************************************************************** *
 *                                                                         *
...
@Singleton
public class TurnRestrictedFastAStarLandmarksFactory implements TurnRestrictedLeastCostPathCalculatorFactory {
	...
	@Inject
	public TurnRestrictedFastAStarLandmarksFactory() {
	...
	public synchronized TurnRestrictedLeastCostPathCalculator createPathCalculator(final Network network, final Lanes lanes, final TravelDisutility travelCosts, final TravelTime travelTimes) {
		...
		return new TurnRestrictedFastAStarLandmarks(routingNetwork, travelCosts, travelTimes, preProcessLandmarks, overdoFactor, fastRouterFactory);
	}
}