...
public class LinkToLinkRandomizingTimeDistanceTravelDisutilityFactory implements LinkToLinkTravelDisutilityFactory {
	
	private static final Logger log = Logger.getLogger(LinkToLinkRandomizingTimeDistanceTravelDisutilityFactory.class);
	...
	public LinkToLinkRandomizingTimeDistanceTravelDisutilityFactory(final String mode, PlanCalcScoreConfigGroup cnScoringGroup) {
		this.mode = mode;
		this.cnScoringGroup = cnScoringGroup;
	}

	@Override
	public LinkToLinkTravelDisutility createLinkToLinkTravelDisutility(final LinkToLinkTravelTime travelTime) {
		...
		return new LinkToLinkRandomizingTimeDistanceTravelDisutility(
				travelTime,
	...
	public LinkToLinkRandomizingTimeDistanceTravelDisutilityFactory setSigma(double val ) {
		this.sigma = val ;
		return this;
	}
}