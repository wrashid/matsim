 ...
 *
 */
class ScoringFunctionsForPopulationOld implements BasicEventHandler, EventsToLegs.LegHandler, EventsToActivities.ActivityHandler, ExperiencedPlansService {

	private final static Logger log = Logger.getLogger(ScoringFunctionsForPopulationOld.class);
	...
	@Inject
	ScoringFunctionsForPopulationOld(EventsManager eventsManager, EventsToActivities eventsToActivities, EventsToLegs eventsToLegs,
	...
	synchronized public void handleLeg(PersonExperiencedLeg o) {
		...
		Leg leg = o.getLeg();
		ScoringFunction scoringFunction = ScoringFunctionsForPopulationOld.this.getScoringFunctionForAgent(agentId);
		if (scoringFunction != null) {
