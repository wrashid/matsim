...
public class HighestWeightSelectorTest {
	...
	public static Fixture createPartiallyJointPlansTwoSelectedJps() {
		...
		group.addPerson( person );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -15d ));
	...
	public static Fixture createPartiallyJointPlansMessOfJointPlans() {
		...
		jp4.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( 7000d ));
		jp5.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( 200d ));
		jp8.put( id , plan );
		...
		group.addPerson( person );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( 1700d ));
	...
	public static Fixture createOneBigJointPlanDifferentNPlansPerAgent() {
		...
		plan.setScoreInfo(new ScoreInfoImpl( -5000d ));
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -15000d ));
	...
	public static Fixture createPartiallyJointPlansNoSelectedJp() {
		...
		toBeSelected.add( plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( 1000d ));
		jp1.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -1000d ));
		plan = person.createAndAddPlan( false );
	...
	public static Fixture createOneBigJointPlanDifferentNPlansPerAgentWithNullScores() {
		...
		group.addPerson( person );
		PlanImpl plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -1295836d ));
		jp.put( id , plan );
		...
		group.addPerson( person );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -12348597d ));
		jp.put( id , plan );
		plan = person.createAndAddPlan( false );
		...
		group.addPerson( person );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -1043872360d ));
		jp.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( null ));
		...
		group.addPerson( person );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -159484723d ));
		jp.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -5000d ));
		plan = person.createAndAddPlan( false );
	...
	public static Fixture createPlanWithDifferentSolutionIfBlocked() {
		...
		jp1.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -123445d ));
		jp2.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( 1000d ));
		Plan p2 = plan;
		...
		Plan p3 = plan;
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -123454d ));
		jp2.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( -1295836d ));
		jp3.put( id , plan );
	...
	public static Fixture createPlanWithNoSolutionIfBlocked() {
		...
		group.addPerson( person );
		PlanImpl plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( 10000d ));
		Plan p1 = plan;
		...
		jp1.put( id , plan );
		plan = person.createAndAddPlan( false );
		plan.setScoreInfo(new ScoreInfoImpl( 100000d ));
		Plan p2 = plan;
	...
	public static Fixture createDifferentForbidGroupsPerJointPlan() {
		...
		group.addPerson( person );
		final PlanImpl p11 = person.createAndAddPlan( false );
		p11.setScoreInfo(new ScoreInfoImpl( 1d ));
		jp1.put( id , p11 );
		final PlanImpl p12 = person.createAndAddPlan( false );
		p12.setScoreInfo(new ScoreInfoImpl( 1d ));
		jp2.put( id , p12 );
		...
		group.addPerson( person );
		final PlanImpl p21 = person.createAndAddPlan( false );
		p21.setScoreInfo(new ScoreInfoImpl( 0d ));
		jp1.put( id , p21 );
		final PlanImpl p22 = person.createAndAddPlan( false );
		p22.setScoreInfo(new ScoreInfoImpl( 10d ));
		jp2.put( id , p22 );
		...
		group.addPerson( person );
		final PlanImpl p31 = person.createAndAddPlan( false );
		p31.setScoreInfo(new ScoreInfoImpl( 1d ));
		jp3.put( id , p31 );
		final PlanImpl p32 = person.createAndAddPlan( false );
		p32.setScoreInfo(new ScoreInfoImpl( 1d ));
		jp4.put( id , p32 );
		...
		group.addPerson( person );
		final PlanImpl p41 = person.createAndAddPlan( false );
		p41.setScoreInfo(new ScoreInfoImpl( 0d ));
		jp3.put( id , p41 );
		final PlanImpl p42 = person.createAndAddPlan( false );
		p42.setScoreInfo(new ScoreInfoImpl( 1d ));
		jp4.put( id , p42 );
