...
public class SpatialDataInputs {
	...
	public enum EmissionSourceMethod {line, point}

    public final static Logger LOG = Logger.getLogger(SpatialDataInputs.class);
	
	private final EmissionSourceMethod emissionSourceMethod;
	 ...
	 */
	public SpatialDataInputs(final EmissionSourceMethod emissionSourceMethod, final String initialCaseLocation) {
		this.emissionSourceMethod = emissionSourceMethod;
	 ...
	 */
	public SpatialDataInputs(final EmissionSourceMethod linkWeightMethod, final String initialCaseLocation, final String compareToCaseLocation) {
//		this.isComparing = true;
		this.emissionSourceMethod = linkWeightMethod;
//		this.initialCase = initialCaseLocation;
...
//		initialCasePlansFile = initialCase+"/output_plans.xml.gz";
	...
	public EmissionSourceMethod getEmissionSourceMethod() {
		return emissionSourceMethod;
	}
