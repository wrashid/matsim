 ...
 * @author michalm
 */
public class InsertionCostCalculatorImpl implements InsertionCostCalculator {
	...
	public InsertionCostCalculatorImpl(DrtConfigGroup drtConfig, MobsimTimer timer, PenaltyCalculator penaltyCalculator) {
